...
_CDAO_NODES = [
    {
        ...
        "label": "MarketData",
        "definition": "Illustrative local root for market-data concepts.",
        "synonyms": ["market data"],
        "parent_iri": None,
    },
    {
        ...
        "parent_iri": "jpmorgan:data:cdao:NewsAndResearch",
    },
    {
    ...
    },
    {
        ...
        "parent_iri": "jpmorgan:data:cdao:InvestmentData",
    },
    {
...
def illustrative_taxonomy_snapshot() -> list[dict]:
    """Coherent local-only topology, explicitly illustrative."""
    return [
        {
            "iri": node["iri"],
            "label": node["label"],
            "parent_iri": node["parent_iri"],
            "children_iris": [],
            "node_kind": "concept",
            "superclass_iris": [],
            "superproperty_iris": [],
