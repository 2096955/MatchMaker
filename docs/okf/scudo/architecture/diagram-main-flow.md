---
type: Architecture
title: Diagram — Main Flow (superseded)
description: Legacy main-flow diagram doc; superseded by the canonical .mmd set documented
...
| Auto-mapped → Neptune | `persistence_mcp.commit_mapping` | **Currently intercepted by I5** — agent-driven AUTO_MAPPED goes to reviewer queue. Lift gated by [i5-lift-preconditions.md](/specs/i5-lift-preconditions.md) |
