...
CREATE INDEX IF NOT EXISTS idx_provider_id   ON tp_provider (provider_id);
CREATE INDEX IF NOT EXISTS idx_provider_name ON tp_provider (provider_name);
CREATE INDEX IF NOT EXISTS idx_provider_flag ON tp_provider (current_flag);
CREATE TRIGGER trg_provider_updated BEFORE UPDATE ON tp_provider
...
CREATE INDEX IF NOT EXISTS idx_dataset_id       ON tp_dataset (dataset_id);
CREATE INDEX IF NOT EXISTS idx_dataset_provider ON tp_dataset (provider_id);
CREATE INDEX IF NOT EXISTS idx_dataset_flag     ON tp_dataset (current_flag);
CREATE TRIGGER trg_dataset_updated BEFORE UPDATE ON tp_dataset
    FOR EACH ROW EXECUTE FUNCTION console.set_updated_at();
...
CREATE INDEX IF NOT EXISTS idx_col_dataset_id ON tp_dataset_col (dataset_id);
CREATE INDEX IF NOT EXISTS idx_col_flag       ON tp_dataset_col (current_flag);
...
CREATE INDEX IF NOT EXISTS idx_run_dataset  ON etl_run_log (dataset_id, run_date);
CREATE INDEX IF NOT EXISTS idx_run_provider ON etl_run_log (provider_id, run_date);
CREATE INDEX IF NOT EXISTS idx_run_status   ON etl_run_log (run_status);
CREATE INDEX IF NOT EXISTS idx_run_file     ON etl_run_log (file_name, run_status);
...
CREATE INDEX IF NOT EXISTS idx_transform_dataset ON tp_dataset_col_transforms (dataset_id);
DROP TRIGGER IF EXISTS trg_transform_updated ON tp_dataset_col_transforms;
CREATE TRIGGER trg_transform_updated BEFORE UPDATE ON tp_dataset_col_transforms
    FOR EACH ROW EXECUTE FUNCTION console.set_updated_at();
