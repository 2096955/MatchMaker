...
name: rights-odrl
description: >
  How the Rights Specialist turns extracted contract/licence terms into JPMC's
  adapted-ODRL rights model. Use this whenever the task involves interpreting
  digital rights, licensing, permissions, prohibitions, or usage constraints for
  a vendor product — even when phrased as "what are we allowed to do with this
  feed" rather than "ODRL". This is a separate specialist from taxonomy mapping;
